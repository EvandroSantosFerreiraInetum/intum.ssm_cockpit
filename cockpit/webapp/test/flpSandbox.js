		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SSM Cockpit",
									"targetURL": "#inetumssmcockpit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"inetumssmcockpit-display": {
								"semanticObject": "inetumssmcockpit",
								"action": "display",
								"description": " Cockpit e automação DM",
								"title": "SSM Cockpit",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=inetum.ssm.cockpit",
									"url": sap.ui.require.toUrl("inetum/ssm/cockpit")
								}
							}
						}
					}
